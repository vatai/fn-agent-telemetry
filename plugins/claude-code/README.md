...
claude plugin marketplace add https://github.com/vatai/clanker-telemetry.git
...
```json
{
  ...
  "transcript_path": "/home/vatai/.claude/projects/-home-vatai-code-clanker-telemetry/610153d8-….jsonl",
  "raw": {
    "session_id": "610153d8-…",
    "transcript_path": "…",
    "cwd": "…",
